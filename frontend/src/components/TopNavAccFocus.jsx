      ...
      <>
        ...
        >
          ...
          <nav className={styles.menu}>
            ...
            <div className={styles.button} onClick={() => navigate(`/group/${userId}`)}>
              <div className={styles.heading}>
                <div className={styles.title}>CỘNG ĐỒNG</div>
              </div>
            </div>
            <div className={styles.buttonFocus} onClick={() => navigate(`/accountthuvien/${userId}`)}>
              <div className={styles.heading}>
        ...
        <nav className={[styles.dropdownMenu, menuOpen ? styles.menuOpen : ""].join(" ")}>
          ...
          <div className={styles.DButton} onClick={() => navigate(`/group/${userId}`)}>
            <div className={styles.heading}>
              <div className={styles.title}>CỘNG ĐỒNG</div>
            </div>
          </div>
          <div className={styles.DButtonFocus} onClick={() => navigate(`/accountthuvien/${userId}`)}>
            <div className={styles.heading}>
              <div className={styles.title}>TÀI KHOẢN</div>
            </div>
          </div>
