      ...
      <>
        ...
        >
          ...
          <nav className={styles.menu}>
            ...
            {isAdmin && (
              <div className={styles.buttonFocus} onClick={() => navigate('/admin')}>
                <div className={styles.heading}>
        ...
        <nav className={[styles.dropdownMenu, menuOpen ? styles.menuOpen : ""].join(" ")}>
          ...
          {isAdmin && (
              <div className={styles.DButtonFocus} onClick={() => navigate('/admin')}>
                <div className={styles.heading}>
                  <div className={styles.title}>QUẢN LÝ</div>
                </div>
              </div>
