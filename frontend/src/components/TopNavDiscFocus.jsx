      ...
      <>
        ...
        >
          ...
          <nav className={styles.menu}>
            <div className={styles.buttonFocus} onClick={() => navigate('/timkiem')}>
        ...
        <nav className={[styles.dropdownMenu, menuOpen ? styles.menuOpen : ""].join(" ")}>
          <div className={styles.DButtonFocus} onClick={() => navigate('/timkiem')}>
            <div className={styles.heading}>
              <div className={styles.title}>KHÁM PHÁ</div>
            </div>
          </div>
