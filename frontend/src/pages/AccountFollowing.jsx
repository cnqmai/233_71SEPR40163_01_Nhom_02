...
import styles from "./AccountFollowing.module.css";
...
const AccountFollowing = () => {
  ...
  const fetchUserData = useCallback(async (userId) => {
    ...
    try {
      ...
      setFollowedUsers(followResponse.data.DangTheoDoi);
    } catch (error) {
  ...
  return (
    <>
      <div className={styles.accountfollowing}>
        <TopNavAcc />
        <div className={styles.body}>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.heading}>
              <div className={styles.angTheoDi}>Đang theo dõi</div>
            </div>
                ...
                followedUsers.map(user => (
                  <div key={user._id} className={styles.item}>
                    ...
                    <div className={styles.container2}>
                      ...
                      <div className={styles.description4}>Joined {format(new Date(user.NgayTao), "MMMM yyyy")}</div>
                      <div className={styles.description4}>{user.GioiThieu}</div>
                      <div className={styles.follow}>
                        <button className={styles.description6}>
                          {user.DangTheoDoi.length} following
                        </button>
                        <button className={styles.description6}>
                          {user.NguoiTheoDoi.length} followers
                        </button>
                      </div>
                    </div>
                  </div>
        ...
        <div className={styles.buttonWrapper}>
          <div className={styles.button1}>
            <div className={styles.primary} />
            <div className={styles.angTheoDi}>Xem thêm</div>
          </div>
        </div>
        <Footer />
      </div>
