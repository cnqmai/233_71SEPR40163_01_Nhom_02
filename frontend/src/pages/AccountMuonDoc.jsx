...
import styles from "./AccountMuonDoc.module.css";

const AccountMuonDoc = () => {
  ...
  return (
    <>
      <div className={styles.accountmuondoc}>
        <TopNavAcc />
              ...
              <div className={styles.container2}>
                <div className={styles.headingParent}>
                  <div className={styles.heading1}>
                    <div className={styles.munC}>Muốn đọc</div>
                  </div>
